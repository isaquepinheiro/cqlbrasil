...
import 'package:cqlbr_firestore/cqlbr_firestore.dart';
  ...
  group('A group of tests -', () {
    ...
    test(
      ...
      () async {
        ...
        print('snapshot1=>${snapshot1.docs.length.toString()}');
        print('snapshot2=>${snapshot2.docs.length.toString()}');
    ...
    test(
      ...
      () async {
        ...
        await result1.get().then((QuerySnapshot snapshot) {
          ...
          print("Ocorreu um erro ao obter o QuerySnapshot: $error");
        });
